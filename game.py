...
class Ball:
    ...
    def bounce(self, axis):
        ...
        if axis == 'y':
            self.dir_x *= -1
        #shooting.play() if we want sound
...
#CONTROLS
    ...
    while controls.liveVideo.isOpened():
        _, frame = controls.liveVideo.read()
        ...
        #also add lower and upper threshold to avoid negative values
        game.paddles['user'].detectMove(controls.yCoordinate)
